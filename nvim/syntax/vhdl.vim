...
syn keyword	vhdlKeyword	access after alias all
syn keyword 	vhdlKeyword	attribute
syn keyword 	vhdlKeyword	assert assume
syn keyword 	vhdlKeyword	buffer bus
syn keyword 	vhdlKeyword	constant
syn keyword 	vhdlKeyword	context cover
syn keyword 	vhdlKeyword	default disconnect
syn keyword 	vhdlKeyword	file
syn keyword 	vhdlKeyword	fairness force
syn keyword 	vhdlKeyword	guarded
syn keyword 	vhdlKeyword	impure in inertial inout
syn keyword 	vhdlKeyword	label library linkage literal
syn keyword 	vhdlKeyword	new next null
syn keyword 	vhdlKeyword	open others out
syn keyword 	vhdlKeyword	postponed pure
syn keyword 	vhdlKeyword	parameter property protected private
syn keyword 	vhdlKeyword	register reject return
syn keyword 	vhdlKeyword	release restrict
syn keyword 	vhdlKeyword	signal shared
syn keyword 	vhdlKeyword	sequence strong
syn keyword 	vhdlKeyword	transport
syn keyword 	vhdlKeyword	unaffected units use
syn keyword 	vhdlKeyword	variable view
syn keyword 	vhdlKeyword	vpkg vmode vprop vunit
syn keyword 	vhdlStatement	architecture array
syn keyword 	vhdlStatement	begin block body
syn keyword 	vhdlStatement	component configuration
syn keyword 	vhdlStatement	downto
syn keyword 	vhdlStatement	end entity exit
syn keyword 	vhdlStatement	function
syn keyword 	vhdlStatement	generate generic group
syn keyword 	vhdlStatement	is
syn keyword 	vhdlStatement	map
syn keyword 	vhdlStatement	new next null
syn keyword 	vhdlStatement	of on
syn keyword 	vhdlStatement	port
syn keyword 	vhdlStatement	package procedure process
syn keyword 	vhdlStatement	range record report
syn keyword 	vhdlStatement	select severity subtype
syn keyword 	vhdlStatement	to type
syn keyword 	vhdlStatement	until
syn keyword 	vhdlStatement	wait with
syn keyword     vhdlConditional case elsif then when
syn keyword     vhdlRepeat      for while loop
